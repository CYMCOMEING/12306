...
class Timer:
    def __init__(self, sleep_interval=0.5) -> None:
        buy_time_everyday = '2020-12-22 09:59:59.500'
        ...
        self.diff_time = self.local_server_time_diff()
    ...
    def local_server_time_diff(self):
        """
        计算本地与服务器时间差
        :return:
        """
